...
Write a function that accepts an object and an integer as
 and adds a new property to the object called yearBorn. The value of the yearBorn property should be the integer that was passed in.
