...
const countNumberOfElements = (arr) => arr.reduce((num) => {return num + arr[0]}, 0);
...
const calculateAverage = (arr) => {
  var avg = arr.reduce((acc, val) => acc + val) / arr.length;
  return(avg)
}
...
Write a function named countPrimeNumbers that, given an array elements as input, uses reduce to count the number of elements that are pret numKids = arr.reduce( (accumulator, value, idx) =>{


    }, 0);et numKids = arr.reduce( (accumulator, value, idx) =>{
